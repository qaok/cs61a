...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8b
            if place.ant.can_contain(self):   #到这步时，已经运行过一次了，place.ant即为第一次添加的ant，self代指此时要运行的ant
...
class ContainerAnt(Ant):
    ...
    def remove_ant(self, ant):
        ...
        elif isinstance(self.ant_contained, QueenAnt):
            self.ant_contained = self.ant_contained
        else:
            self.ant_contained = None
