...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        return roll_dice(num_rolls, dice)#此处的dice默认为six_sided，但如果输入时指定了dice，那么就为指定的dice
    # END PROBLEM 3
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_rolls_n(score, opponent_score):
        return n
    return always_rolls_n
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    max_num = 1
    cur_num = 1
    max_average = make_averaged(roll_dice, samples_count)(1, dice)
    while cur_num < 10:
        cur_num += 1
        cur_average = make_averaged(roll_dice, samples_count)(cur_num, dice)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    last_score = sus_points(boar_score) - score
